...
Public Class AssistantMngr_Dashboard_Form
    ...
    Private Sub LoadItems()
        Try
            ...
            Dim query As String = "SELECT ProductID, ProductName, Category, Quantity, DateAdded " &
    ...
    Private Sub Dashboard_BTN4_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Report_BTN_Click_1(sender As Object, e As EventArgs) Handles Report_BTN.Click
        Dim Obj = New AssistantMngr_Report_Form
        Obj.Show()
        Me.Hide()
    End Sub

    Private Sub Financial_BTN_Click_1(sender As Object, e As EventArgs) Handles Financial_BTN.Click
        Dim Obj = New AssistantMngr_Expense_Form
        Obj.Show()
        Me.Hide()
    End Sub

    Private Sub Cashier_BTN_Click_1(sender As Object, e As EventArgs) Handles Cashier_BTN.Click
        Dim Obj = New AssistantMngr_Cashier_Form
        Obj.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Maintenance_BTN_Click_1(sender As Object, e As EventArgs)
        Dim Obj = New AssistantMngr_Maintenance_UI_Form
        Obj.Show()
        Me.Hide()
    End Sub

    Private Sub Button14_Click_1(sender As Object, e As EventArgs) Handles BTN_LOGOUT.Click
        Dim Obj = New Login_form
        Obj.Show()
        Me.Hide()
    End Sub
