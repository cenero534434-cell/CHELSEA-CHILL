...
Imports Mysqlx.Crud
Public Class AssistantMngr_Expense_Form
    ...
    Private Sub DataGridExpenses_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridExpenses.CellContentClick
