...
Public Class Manager_Cashier_Form
    ...
    Private Sub BTN_CATNOODLES_Click(sender As Object, e As EventArgs) Handles BTN_CATNOODLES.Click
        fetchProductData("Noodles")
    End Sub

    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button16.Click
        Dim Obj = New ManageProduct_Form
        Obj.Show()
    End Sub
